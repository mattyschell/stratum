...
\i ./src/main/sql/definition/postgresql/schema-stratum_catalog.sql
set SEARCH_PATH=bldg_blue,public;
\i ./src/main/sql/definition/postgresql/schema-bldg.sql
set SEARCH_PATH=bldg_green,public;
\i ./src/main/sql/definition/postgresql/schema-bldg.sql
set SEARCH_PATH=bldg_read,public;
\i ./src/main/sql/definition/postgresql/schema-bldg_read.sql
-- taxmap
-- cscl
-- basemap